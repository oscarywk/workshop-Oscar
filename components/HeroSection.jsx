          ...
          >
            <h1 className="font-extrabold">
              ...
              <TypeWritter
                ...
                onInit={(typewriter) => {
                    typewriter
                    .typeString`<span style="color:#FF77FF">Banking Student</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#9E7BFF">Finance Student</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .typeString`<span style="color:#893BFF">Creativity Student</span>`
                    .pauseFor(1500)
                    .deleteAll()
                    .start();
            ...
            <p className="text-gray-300 pt-8 text-base sm:text-lg mb-6 lg:text-xl">
              ...
              <Link
                href="https://drive.google.com/file/d/1zQSoKvvd6Xd5eecCMQlCiyun38ZiP-bY/view?usp=sharing"
